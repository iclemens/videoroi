classdef GUICheckbox < GUIComponent
    ...
    methods
        ...
        function constructObject(obj)
            ...
            if(parentHandle ~= 0)            
                obj.handle = uicontrol('Parent', parentHandle, 'Style', 'checkbox', 'Value', obj.value, 'Units', 'pixels', 'String', obj.label);
